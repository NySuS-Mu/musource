...
{
		if((item_num <= GET_ITEM(0,31))
			//|| (item_num == GET_ITEM(0,49)) Ejemplo de como agregar items de forma individual
			//|| (item_num >= GET_ITEM(0,75) && item_num <= GET_ITEM(0,79)) Ejemplo de como agregar items de forma global, recuerden que no tiene que tener saltos de item
			||(item_num >= GET_ITEM(1,0) && item_num <= GET_ITEM(2,2))
			|| (item_num == GET_ITEM(2,16))
			//Index4
			|| (item_num == GET_ITEM(4,7))
			|| (item_num == GET_ITEM(4,15))
			)
	{
		return true;
	}
...
bool LockItem(int item_num)
{
	if((item_num >= GET_ITEM(0,9) && item_num <= GET_ITEM(0,12))
			|| (item_num == GET_ITEM(0,15))
			||(item_num >= GET_ITEM(0,17) && item_num <= GET_ITEM(0,18))
			|| (item_num == GET_ITEM(0,21))
			||(item_num >= GET_ITEM(0,23) && item_num <= GET_ITEM(0,25))
			|| (item_num == GET_ITEM(0,31))
			//Index 1
			||(item_num >= GET_ITEM(1,5) && item_num <= GET_ITEM(1,8))
			//Index 2
			||(item_num >= GET_ITEM(2,3) && item_num <= GET_ITEM(2,6))
			||(item_num >= GET_ITEM(2,8) && item_num <= GET_ITEM(2,15))
			||(item_num >= GET_ITEM(2,17) && item_num <= GET_ITEM(2,18))
			//Index 3 y 4
			||(item_num >= GET_ITEM(3,0) && item_num <= GET_ITEM(4,6))
			||(item_num >= GET_ITEM(4,8) && item_num <= GET_ITEM(4,14))
			//Index 4 y 5
			||(item_num >= GET_ITEM(4,16) && item_num < GET_ITEM(6,0))
			)
	{
		return true;
	}
...
bool ClawsRF(int item_num)
{
		if((item_num >= GET_ITEM(0,32) && item_num <= GET_ITEM(0,35))
			//|| (item_num == GET_ITEM(0,120)) Ejemplo de como agregar items de forma individual
			//|| (item_num >= GET_ITEM(0,150) && item_num <= GET_ITEM(0,156)) Ejemplo de como agregar items de forma global, recuerden que no tiene que tener saltos de item
			)
	{
		return true;
	}
...
void CItemManager::CGMoveItemProc(PMSG_MOVEITEM* aRecv, short aIndex) {
	...
	else if (aRecv->tFlag == 0 && aRecv->sFlag == 0) //equip/unequip item
	{
		...
		if (aRecv->Source > 11) { //wear equipment case
			...
			//Index 12
			if ((lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 7))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 8))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 9))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 10))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 11))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 12))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 13))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 14))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 15))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 16))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 17))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 18))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 19))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 20))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 21))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 22))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 23))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 24))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 25))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 26))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 27))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 28))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 29))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 30))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 31))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 32))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 33))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 34))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 35))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 44))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 45))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 46))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 47))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 48))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 60))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 61))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 62))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 63))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 64))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 65))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 66))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 67))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 68))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 69))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 70))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 71))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 72))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 73))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 74))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 75))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 76))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 77))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 78))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 79))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 80))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 81))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 82))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 83))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 84))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 85))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 86))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 87))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 88))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 89))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 90))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 91))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 92))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 93))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 94))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 95))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 96))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 97))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 98))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 99))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 100))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 101))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 102))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 103))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 104))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 105))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 106))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 107))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 108))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 109))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 110))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 111))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 112))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 113))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 114))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 115))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 116))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 117))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 118))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 119))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 120))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 121))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 122))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 123))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 124))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 125))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 126))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 127))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 128))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 129))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 136))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 137))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 138))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 139))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 140))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 141))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 142))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(12, 143))
			//Index 13
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 7)) 
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 11))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 14))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 15))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 16))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 17))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 18))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 19))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 29)) 
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 31))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 32))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 33))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 34))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 35))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 36))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 43))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 44))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 45))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 46))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 47))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 48))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 49))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 50))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 51))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 52))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 53))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 54))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 55))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 56))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 57))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 58))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 59))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 60))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 61))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 62))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 63))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 66))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 69))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 70))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 71))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 72))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 73))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 74))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 75))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 81))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 82))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 83))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 84))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 85))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 86))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 87))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 88))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 89))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 90))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 91))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 92))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 93))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 94))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 95))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 96))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 97))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 98))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 99))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 100))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 101))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 102))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 103))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 104))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 105))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 116))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 117))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 118))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 119))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 120))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 121))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 121))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 124))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 125))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 126))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 127))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 128))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 129))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 130))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 131))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 132))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 133))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 134))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 135))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 136))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 137))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 138))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 139))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 140))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 141))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 142))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 143))
				|| (lpObj->Inventory[aRecv->Source].m_Index == GET_ITEM(13, 144))
			//Index 14 y 15
				|| (lpObj->Inventory[aRecv->Source].m_Index >= GET_ITEM(14, 0) && lpObj->Inventory[aRecv->Source].m_Index <= GET_ITEM(15, 36))
				)
			{
			...
			if ((lpObj->Class == CLASS_RF && !lpObj->Inventory[0].IsItem() && !lpObj->Inventory[1].IsItem() && ClawsRF(lpObj->Inventory[aRecv->Source].m_Index))
			|| (lpObj->Class == CLASS_RF && ClawsRF(lpObj->Inventory[1].m_Index) && ClawsRF(lpObj->Inventory[aRecv->Source].m_Index))
				)
				{
					pMsg.TargetSlot = 0;
			}
			else if ((lpObj->Class == CLASS_RF && !lpObj->Inventory[0].IsItem() && ClawsRF(lpObj->Inventory[1].m_Index) && !ClawsRF(lpObj->Inventory[aRecv->Source].m_Index))
						 || (lpObj->Class == CLASS_RF && !lpObj->Inventory[0].IsItem() && !ClawsRF(lpObj->Inventory[1].m_Index) && ClawsRF(lpObj->Inventory[aRecv->Source].m_Index))
						 )
					{
						return;
					}
			else if (pMsg.TargetSlot == 0
				&& lpObj->Inventory[0].IsItem() //slot 0 already has item
				&& !lpObj->Inventory[1].IsItem())//slot 1 is empty
				{
					if(LockItem(lpObj->Inventory[0].m_Index))
					{
						return;
					}
					else if ((IsItem(lpObj->Inventory[0].m_Index) && lpObj->Class == CLASS_DW)
						 || (IsItem(lpObj->Inventory[0].m_Index) && lpObj->Class == CLASS_ELF)
						 || (IsItem(lpObj->Inventory[0].m_Index) && lpObj->Class == CLASS_DL)
						 || (lpObj->Class == CLASS_RF && ClawsRF(lpObj->Inventory[0].m_Index) && !ClawsRF(lpObj->Inventory[aRecv->Source].m_Index))
						 || (lpObj->Class == CLASS_RF && !ClawsRF(lpObj->Inventory[0].m_Index) && ClawsRF(lpObj->Inventory[aRecv->Source].m_Index))
						 )
					{
						return;
					}
					else if ((IsItem(lpObj->Inventory[0].m_Index))
						 || (lpObj->Class == CLASS_RF && ClawsRF(lpObj->Inventory[0].m_Index) && ClawsRF(lpObj->Inventory[aRecv->Source].m_Index))
					)
					{
					pMsg.TargetSlot = 1;
