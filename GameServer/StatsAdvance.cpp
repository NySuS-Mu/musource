...
void CStatsAdvance::Send(int aIndex)
{
	...
	pMsg.StatInfo.DamageReductionRate = lpUser->DamageReduction[MAX_DAMAGE_REDUCTION];
	...
	pMsg.StatInfo.IncreaseDamagePvP = lpUser->DamagePvP;
	pMsg.StatInfo.IncreaseDefencePvP = lpUser->DefensePvP;
