...
void CServerDisplayer::Init(HWND hWnd) // OK
{
	...
	gLog.AddLog(gServerInfo.m_WriteSmithItemLog,"LOG\\SMITHITEM_LOG");
}
...
void CServerDisplayer::SetWindowName() // OK
{
	...
	wsprintf(buff,"[%s] %s (ON: %d) KoshGames RePack - Louis/MuEMU Emulator",GAMESERVER_VERSION,gServerInfo.m_ServerName, gObjTotalUser);
